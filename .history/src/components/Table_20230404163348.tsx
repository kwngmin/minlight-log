    ...
    <article className="pb-4">
      ...
      <ul>
        {tableData.map(({ head, content, period }) => (
          <li
            key={head}
            className="flex flex-col lg:flex-row lg:items-center justify-center lg:justify-start pt-4 pb-5 lg:py-0 lg:h-16 border-t gap-0 lg:gap-4 px-4 lg:px-8 mb-2 lg:mb-0"
          >
